...
- [Run Agents Through Local Omnigent](/guides/local-omnigent) — pin a local Omnigent service, select Codex or distinct Claude-compatible auth profiles, and attach through herdr or tmux.
