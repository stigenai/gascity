...
/**
 * Get v0 city by city name omnigent capsule state
 */
export const getV0CityByCityNameOmnigentCapsuleState = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameOmnigentCapsuleStateData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameOmnigentCapsuleStateResponses, GetV0CityByCityNameOmnigentCapsuleStateErrors, ThrowOnError>({ url: '/v0/city/{cityName}/omnigent/capsule-state', ...options });

/**
 * Post v0 city by city name omnigent capsule state by ID purge
 */
export const postV0CityByCityNameOmnigentCapsuleStateByIdPurge = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameOmnigentCapsuleStateByIdPurgeData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameOmnigentCapsuleStateByIdPurgeResponses, PostV0CityByCityNameOmnigentCapsuleStateByIdPurgeErrors, ThrowOnError>({
...
/**
 * Get v0 city by city name omnigent status
 *
 * Results are ordered (created_at DESC, id DESC) — newest Omnigent sessions first. A truncated response always carries next_cursor; passing it back returns the next page in the same order. Invalid or legacy cursors are rejected with a typed 400 (invalid-cursor).
 */
export const getV0CityByCityNameOmnigentStatus = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameOmnigentStatusData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameOmnigentStatusResponses, GetV0CityByCityNameOmnigentStatusErrors, ThrowOnError>({ url: '/v0/city/{cityName}/omnigent/status', ...options });
...
/**
 * Get v0 city by city name session by ID terminal
 */
export const getV0CityByCityNameSessionByIdTerminal = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameSessionByIdTerminalData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameSessionByIdTerminalResponses, GetV0CityByCityNameSessionByIdTerminalErrors, ThrowOnError>({ url: '/v0/city/{cityName}/session/{id}/terminal', ...options });

/**
 * Post v0 city by city name session by ID terminal detach
 */
export const postV0CityByCityNameSessionByIdTerminalDetach = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameSessionByIdTerminalDetachData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameSessionByIdTerminalDetachResponses, PostV0CityByCityNameSessionByIdTerminalDetachErrors, ThrowOnError>({ url: '/v0/city/{cityName}/session/{id}/terminal/detach', ...options });

/**
 * Post v0 city by city name session by ID terminal input
 */
export const postV0CityByCityNameSessionByIdTerminalInput = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameSessionByIdTerminalInputData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameSessionByIdTerminalInputResponses, PostV0CityByCityNameSessionByIdTerminalInputErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name session by ID terminal interrupt
 */
export const postV0CityByCityNameSessionByIdTerminalInterrupt = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameSessionByIdTerminalInterruptData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameSessionByIdTerminalInterruptResponses, PostV0CityByCityNameSessionByIdTerminalInterruptErrors, ThrowOnError>({ url: '/v0/city/{cityName}/session/{id}/terminal/interrupt', ...options });

/**
 * Post v0 city by city name session by ID terminal keys
 */
export const postV0CityByCityNameSessionByIdTerminalKeys = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameSessionByIdTerminalKeysData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameSessionByIdTerminalKeysResponses, PostV0CityByCityNameSessionByIdTerminalKeysErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name session by ID terminal resize
 */
export const postV0CityByCityNameSessionByIdTerminalResize = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameSessionByIdTerminalResizeData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameSessionByIdTerminalResizeResponses, PostV0CityByCityNameSessionByIdTerminalResizeErrors, ThrowOnError>({
