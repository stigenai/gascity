...
type Bead struct {
	...
	// UpstreamStatus preserves a non-canonical bd status for display. Status
	// remains Gas City's three-state scheduling contract; callers must not use
	// this field to decide readiness.
