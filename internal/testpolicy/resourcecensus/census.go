	...
	AuditBaseline: []Baseline{
		{
			...
			ReportedCalls:   495,
			ReportedFiles:   135,
			OwnerBead:       "ga-xgv.5.3",
			Invariant:       "tracked test source totals remain visible as audit evidence",
			ResourceOwner:   "ga-xgv.5.3 owns the isolated SSH persistent-state fixture; ga-xgv.5.2, ga-xgv.4.5, ga-dfk, and ga-80po0c.2 own the remaining source census",
