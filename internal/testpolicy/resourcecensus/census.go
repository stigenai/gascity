	...
	AuditBaseline: []Baseline{
		{
			...
			ReportedCalls:   495,
			ReportedFiles:   135,
			OwnerBead:       "ga-xgv.7.2",
			Invariant:       "tracked test source totals remain visible as audit evidence",
			ResourceOwner:   "ga-xgv.7.2 owns exact leaked-process-group PID diagnostics; ga-xgv.6.2 owns the integration-tagged Herdr-to-remote full-terminal fixture; ga-xgv.5.5, ga-xgv.5.4, ga-xgv.5.3, ga-xgv.5.2, ga-xgv.4.5, ga-dfk, and ga-80po0c.2 own the remaining source census",
	...
	Debt: []Baseline{
		{
			...
			ResourceOwner:   "ga-dfk replaces redundant Omnigent process fixtures; other owners remove their source call sites",
		...
		},
		{
			...
			ResourceOwner:   "ga-dfk replaces redundant Omnigent loopback fixtures; retained owners close every server",
		...
		},
		{
			...
			ResourceOwner:   "ga-dfk replaces redundant Omnigent listeners; retained owners close every stream listener",
	...
	SmallDebt: []Baseline{
		{
			...
			ResourceOwner:   "ga-dfk replaces redundant Omnigent process fixtures; other non-Medium owners remove each call site",
			MigrationTarget: "D1/D2/D5/D6/E6",
			Expires:         "2026-10-01",
		},
		{
		...
		},
		{
			...
			ResourceOwner:   "ga-dfk replaces redundant Omnigent servers; other non-Medium owners move or replace listener coverage",
			MigrationTarget: "P0.4c",
			Expires:         "2026-10-01",
		},
		{
		...
		},
		{
			...
			ResourceOwner:   "ga-dfk replaces redundant Omnigent listeners; other non-Medium owners move or replace listener coverage",
			MigrationTarget: "P0.4c-listener",
			Expires:         "2026-10-01",
		},
		{
