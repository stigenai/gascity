...
| Audit baseline | all tracked test source | subprocess: 551 calls / 174 files (historical regex census: 495 / 135) | ga-xgv.6.2 | tracked test source totals remain visible as audit evidence; ga-xgv.6.2 owns the integration-tagged Herdr-to-remote full-terminal fixture; ga-xgv.5.5, ga-xgv.5.4, ga-xgv.5.3, ga-xgv.5.2, ga-xgv.4.5, ga-dfk, and ga-80po0c.2 own the remaining source census | P0.4a | 2026-10-01 |
