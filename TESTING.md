...
| --- | --- | --- | --- | --- | --- | --- |
| Audit baseline | all tracked test source | fixed_sleep: 431 calls / 158 files (historical regex census: 447 / 157) | ga-80po0c.2 | tracked test source totals remain visible as audit evidence; ga-80po0c.2 owns this point-in-time source census | P0.4a | 2026-10-01 |
...
| Audit baseline | all tracked test source | subprocess: 553 calls / 174 files (historical regex census: 495 / 135) | ga-xgv.7.2 | tracked test source totals remain visible as audit evidence; ga-xgv.7.2 owns exact leaked-process-group PID diagnostics; ga-xgv.6.2 owns the integration-tagged Herdr-to-remote full-terminal fixture; ga-xgv.5.5, ga-xgv.5.4, ga-xgv.5.3, ga-xgv.5.2, ga-xgv.4.5, ga-dfk, and ga-80po0c.2 own the remaining source census | P0.4a | 2026-10-01 |
...
| Small debt ratchet | all untagged test source | http_test_server: 332 calls / 68 files (historical regex census: 300 / 66) | ga-dfk | untagged Small HTTP test server call/file totals cannot grow; reductions must lower this baseline; ga-dfk replaces redundant Omnigent servers; other non-Medium owners move or replace listener coverage | P0.4c | 2026-10-01 |
...
| Small debt ratchet | all untagged test source | net_listen: 99 calls / 38 files (historical regex census: 92 / 34) | ga-dfk | untagged Small stream-listener call/file totals cannot grow; reductions must lower this baseline; ga-dfk replaces redundant Omnigent listeners; other non-Medium owners move or replace listener coverage | P0.4c-listener | 2026-10-01 |
...
| Small debt ratchet | all untagged test source | subprocess: 397 calls / 111 files (historical regex census: 394 / 105) | ga-dfk | untagged Small subprocess call/file totals cannot grow; reductions must lower this baseline; ga-dfk replaces redundant Omnigent process fixtures; other non-Medium owners remove each call site | D1/D2/D5/D6/E6 | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | http_test_server: 332 calls / 68 files (historical regex census: 255 / 56) | ga-dfk | untagged HTTP test server call/file totals cannot grow; reductions must lower this baseline; ga-dfk replaces redundant Omnigent loopback fixtures; retained owners close every server | P0.4c | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | net_listen: 101 calls / 39 files (historical regex census: 92 / 34) | ga-dfk | untagged stream-listener call/file totals cannot grow; reductions must lower this baseline; ga-dfk replaces redundant Omnigent listeners; retained owners close every stream listener | P0.4c-listener | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | subprocess: 402 calls / 114 files (historical regex census: 380 / 98) | ga-dfk | untagged subprocess call/file totals cannot grow; reductions must lower this baseline; ga-dfk replaces redundant Omnigent process fixtures; other owners remove their source call sites | D1/D2/D5/D6/E6 | 2026-10-01 |
...
|---|---|---|---|---|---|---|---|
| `runtime.builtin.acp` | production_provider | — | `runtime.Provider` | `internal/runtime/acp.NewSeamBacked` | runtime.builtin/exact:acp | `runtime.Provider` | waived by ga-j4q through 2026-10-01: NewSeamBacked always uses shared os.TempDir()/gc-acp state; the WithDir proof does not exercise that composition |
...
| `runtime.builtin.exec` | production_provider | — | `runtime.Provider` | `internal/runtime/t3bridge.NewSeamBacked` | runtime.builtin/prefix:exec: | `runtime.Provider` | waived by ga-j4q through 2026-10-01: the legacy gc-session-t3 prefix branch selects the T3 bridge composition, which has no full shared runtime contract |
...
| `runtime.builtin.herdr` | production_provider | — | `runtime.Provider` | `cmd/gc.newHerdrProvider` | runtime.builtin/exact:herdr | `runtime.Provider` | waived by ga-j4q through 2026-10-01: cmd/gc.newHerdrProvider is the selected production composition; the internal herdr.New conformance proof does not exercise its session-name and state-directory derivation |
| `runtime.builtin.hybrid` | production_provider | — | `runtime.Provider` | `cmd/gc.newHybridProvider` | runtime.builtin/exact:hybrid | `runtime.Provider` | waived by ga-j4q through 2026-10-01: cmd/gc.newHybridProvider is the selected registry construction boundary; its internal tmux, K8s, and hybrid constructors are not claimed here, and the wrapper has no full shared runtime contract |
| `runtime.builtin.k8s` | production_provider | — | `runtime.Provider` | `internal/runtime/k8s.NewSeamBackedForCity` | runtime.builtin/exact:k8s | `runtime.Provider` | waived by ga-j4q through 2026-10-01: the actual K8s production composition has no full shared runtime contract |
| `runtime.builtin.ssh` | production_provider | — | `runtime.Provider` | `internal/runtime/ssh.NewSeamBacked` | runtime.builtin/prefix:ssh: | `runtime.Provider` | waived by ga-j4q through 2026-10-01: the production SSH composition has no full shared runtime contract |
| `runtime.builtin.subprocess` | production_provider | — | `runtime.Provider` | `internal/runtime/subprocess.NewSeamBacked` | runtime.builtin/exact:subprocess | `runtime.Provider` | waived by ga-j4q through 2026-10-01: NewSeamBacked selects a distinct reachable empty-cityPath branch with shared /tmp state; the WithDir proof does not exercise that composition |
...
| `runtime.builtin.t3bridge` | production_provider | — | `runtime.Provider` | `internal/runtime/t3bridge.NewSeamBacked` | runtime.builtin/exact:t3bridge | `runtime.Provider` | waived by ga-j4q through 2026-10-01: the production T3 bridge composition has focused tests but no full shared runtime contract |
| `runtime.builtin.tmux` | production_provider | — | `runtime.Provider` | `internal/runtime/tmux.NewSeamBackedWithConfig` | runtime.builtin/exact:tmux | `runtime.Provider` | waived by ga-j4q through 2026-10-01: the existing full conformance run skips when the tmux executable is absent |
