...
| Audit baseline | all tracked test source | subprocess: 539 calls / 167 files (historical regex census: 495 / 135) | ga-dfk | tracked test source totals remain visible as audit evidence; ga-dfk owns the Omnigent process-fixture increment; ga-80po0c.2 owns the remaining source census | P0.4a | 2026-10-01 |
...
| Small debt ratchet | all untagged test source | http_test_server: 332 calls / 69 files (historical regex census: 300 / 66) | ga-dfk | untagged Small HTTP test server call/file totals cannot grow; reductions must lower this baseline; ga-dfk replaces redundant Omnigent servers; other non-Medium owners move or replace listener coverage | P0.4c | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | http_test_server: 332 calls / 69 files (historical regex census: 255 / 56) | ga-dfk | untagged HTTP test server call/file totals cannot grow; reductions must lower this baseline; ga-dfk replaces redundant Omnigent loopback fixtures; retained owners close every server | P0.4c | 2026-10-01 |
