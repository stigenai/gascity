...
| Audit baseline | all tracked test source | subprocess: 550 calls / 173 files (historical regex census: 495 / 135) | ga-xgv.5.5 | tracked test source totals remain visible as audit evidence; ga-xgv.5.5 owns the isolated SSH attach/cleanup fixtures; ga-xgv.5.4, ga-xgv.5.3, ga-xgv.5.2, ga-xgv.4.5, ga-dfk, and ga-80po0c.2 own the remaining source census | P0.4a | 2026-10-01 |
